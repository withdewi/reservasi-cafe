...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <!-- Categories -->
        <li class="menu-item">
            <a href="{{ url('admin/categories') }}" class="menu-link {{ Route::is('category') ? 'active' : '' }}">
        ...
        <!-- Menus -->
        <li class="menu-item">
            <a href="{{ url('admin/menus') }}" class="menu-link {{ Route::is('menus') ? 'active' : '' }}">
        ...
        <!-- Tables -->
        <li class="menu-item">
            <a href="{{ url('admin/tables') }}" class="menu-link {{ Route::is('tables') ? 'active' : '' }}">
        ...
        <!-- Reservations -->
        <li class="menu-item">
            <a href="{{ url('admin/reservations') }}" class="menu-link {{ Route::is('reservation') ? 'active' : '' }}">
