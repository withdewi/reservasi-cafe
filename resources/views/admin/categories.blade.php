...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default" data-assets-path="../assets/" data-template="vertical-menu-template-free">
  <head>
    ...
    <title>Categories | Sparkles</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3"><span class="text-muted fw-light">Sparkles /</span> Categories</h4>
              <a href="/admin/add-categories" class="btn btn-dark mr-5" style="margin-left: 850px; margin-bottom: 20px;">New Category</a>
                  ...
                  <table class="table">
                    ...
                    @foreach($category as $a)
                      <tr>
                        ...
                        <td><img src="{{ asset('kategori/'.$a->file)}}" alt="" style="width: 80px" height="80px"></td>
                        <td>{{ $a->description }}</td>
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="/admin/edit-categories/{{ $a->id}}"
                                ><i class="bx bx-edit-alt me-1"></i> Edit</a
                              >
                              <a class="dropdown-item" href="/admin/delete-categories/{{ $a->id }}"
