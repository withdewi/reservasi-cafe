...
<html
  ...
  <head>
    ...
    <title>Add Table | Sparkle Cafe</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Sparkles /</span> Add Tables</h4>
            ...
            <div class="row">
              ...
              <!-- Account -->
              <div class="card-body">
                      <form action="{{ route('storeTable') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                          ...
                          <div class="mb-3 mt-3 col-md-6">
                            ...
                            <select id="location" class="select2 form-select">
