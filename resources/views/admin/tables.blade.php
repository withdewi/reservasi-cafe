...
<head>
    ...
    <title>Tables | Sparkle Cafe</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3"><span class="text-muted fw-light">Sparkles /</span> Tables</h4>
              <a href="/admin/add-tables" class="btn btn-dark mr-5" style="margin-left: 850px; margin-bottom: 20px;">New Table</a>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="/admin/edit-tables/{{ $a->id }}"
                                ><i class="bx bx-edit-alt me-1"></i> Edit</a
                              >
                              <a class="dropdown-item" href="/admin/delete-tables/{{ $a->id }}"
