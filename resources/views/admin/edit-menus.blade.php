...
<html
  ...
  <head>
    ...
    <title>Edit Menu | Sparkle Cafe</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3"><span class="text-muted fw-light">Sparkles /</span> Edit Menu</h4>
              <div class="row">
                <div class="col-md-12">
                  <div class="card mb-4">
                    <!-- Account -->
                    <div class="card-body">
                        <form action="/admin/edit-menus/{{ $menu->id }}" method="POST" enctype="multipart/form-data">
                          <div class="row">
                            ...
                            <div>
                              <img src="{{ asset('menu/'.$menu->file)}}" width="80px" height="80px /" style="margin-left: 0px; margin-bottom: 12px; margin-top: 3px;">
                            </div>
                            <div class="mb-3 col-md-6">
                            ...
                            <div class="mb-3 col-md-6">
                              ...
                              <textarea 
                                ...
                                id="categories" 
                                name="categories" 
                                value="{{ $menu->categories }}">{{ $menu->categories }}</textarea>
                            </div>
                          </div>
                          <div class="mt-2">
